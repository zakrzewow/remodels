...
class LogisticScaler(BaseScaler):
    """
    Scaler that applies a logistic transformation to the data. This transformation converts each feature 
    using the logistic function, which maps any real-valued number into the range (0, 1). 
